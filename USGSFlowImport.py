...
def get_usgs_daily_data(site_number, parameter_codes, start_date="1990-10-01", end_date=None):
    ...
    try:
        ...
        dates = [val['dateTime'][:10] for val in param_data[first_param]['values']]
...
def import_arkansas_river_usgs_data():
    ...
    usgs_sites = {
        ...
        '07099235': 'Arkansas River at Moffat Street at Pueblo, CO',
        ...
        '07119700': 'Arkansas River at Las Animas, CO',
        '07120500': 'Arkansas River near Rocky Ford, CO',
        '07123000': 'Arkansas River at La Junta, CO',
        '07124000': 'Arkansas River at Catlin Dam, near Fowler, CO',
    ...
    wqx_mapping = {
        '07094500': 'ARKANSAS RIVER AT PARKDALE, CO.',
        '07099235': 'ARKANSAS RIVER BELOW MOFFAT STREET AT PUEBLO, CO.',
        '07099400': 'ARKANSAS RIVER ABOVE PUEBLO, CO',
        '07099970': 'ARKANSAS RIVER ABOVE PUEBLO, CO.',
        '07109500': 'ARKANSAS RIVER NEAR AVONDALE, CO.',
        '07119700': 'ARKANSAS RIVER AT LAS ANIMAS, CO.',
        '07120500': 'ARKANSAS RIVER NEAR ROCKY FORD, CO.',
        '07123000': 'ARKANSAS RIVER AT LA JUNTA, CO',
